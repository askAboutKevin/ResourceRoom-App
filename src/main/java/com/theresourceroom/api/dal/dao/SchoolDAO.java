...
public interface SchoolDAO {
	...
	@SqlQuery("SELECT id, registered, name, street_address, city, zip_code, country, nces_number, code_hash FROM School")
	@RegisterRowMapper(SchoolMapper.class)
	List<School> getAllSchools();

	@SqlQuery("SELECT id, registered, name, street_address, city, zip_code, country, nces_number, code_hash FROM School WHERE id = ?")
	@RegisterRowMapper(SchoolMapper.class)
	School getSchoolById(int id);

	@SqlQuery("SELECT id, registered, name, street_address, city, zip_code, country, nces_number, code_hash FROM School WHERE nces_number = ?")
	@RegisterRowMapper(SchoolMapper.class)
